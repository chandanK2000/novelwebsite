...
const MultiSelectPrintDetailsPage = () => {
    ...
    const [serialNumberLength, setSerialNumberLength] = useState();
    // const [serialNumberLength, setSerialNumberLength] = useState(null);
            ...
            <div className="row">
                ...
                <div className="col-lg-5">
                    <div className="d-flex justify-content-between">
                        ...
                        {selectedParts.length > 0 && isVisibleCheckbox && (
                            <div>
                                <input
                                    type="checkbox"
                                    checked={checkAll}
                        ...
                        {selectedParts.length > 0 && isVisibleCheckbox ? ( // Conditionally render if parts are selected
                            <div>
                                <label htmlFor="checkAllCheckbox">
                                    {checkAll ? "Uncheck All" : "Check All"}
                                </label>
